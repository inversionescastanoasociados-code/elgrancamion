...
import { WHATSAPP_LINES } from '@/lib/whatsappLines';
  ...
  return (
    ...
    >
      <button
        ...
        onClick={close}
        className="absolute inset-0 bg-black/70 backdrop-blur-md backdrop-fade"
      />

      <div className="relative w-full max-w-lg modal-pop">
